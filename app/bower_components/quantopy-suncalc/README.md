...
*Forked library from original author [Vladimi Agafonkin](https://github.com/mourner/suncalc), used as bower package*
...
SunCalc is also available as an BOWER package:

```bash
$ bower install quantopy-suncalc
```

or add `quantopy-suncalc` to your `bower.json` file for example:

```json
  dependencies":{
    "quantopy-suncalc": "~1.0.0"
  }
```

Then include library from your root directory of your project:

```html
<script type="text/javascript" src="/bower_components/quantopy-suncalc/suncalc.js"></script>
```
...
#### 1.0.0 &mdash; Nov 17, 2015

- Forked repository
- Published to bower package list
